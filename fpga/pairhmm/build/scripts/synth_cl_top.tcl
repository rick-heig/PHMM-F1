...
read_verilog $CL_DIR/ip/bd/compute_unit/hdl/compute_unit_wrapper.v
read_verilog $CL_DIR/ip/bd/floating_point_sum/hdl/floating_point_sum_wrapper.v
#read_verilog $CL_DIR/ip/bd/cl_axi_interconnect_2_to_1_bis/hdl/cl_axi_interconnect_2_to_1_bis_wrapper.v
#read_verilog $CL_DIR/ip/bd/test_axi_ila_1/hdl/test_axi_ila_1_wrapper.v
read_verilog -sv $CL_DIR/design/cl_pairhmm_package.vh   
read_verilog -sv [glob $ENC_SRC_DIR/*.?v]

# Note : IPs and BDs must be generated (generate output products with global option)

# User Board diagram based IPs
read_bd [ list \
          $CL_DIR/ip/bd/cl_axi_interconnect_2_to_1_bis/cl_axi_interconnect_2_to_1_bis.bd \
          $CL_DIR/ip/bd/ocl_interconnect/ocl_interconnect.bd \
          $CL_DIR/ip/bd/floating_point_sum/floating_point_sum.bd \
          $CL_DIR/ip/bd/compute_unit/compute_unit.bd
#          $CL_DIR/ip/bd/test_axi_ila_1/test_axi_ila_1.bd    
]

# User Created IPs
read_ip [ list \
          $CL_DIR/ip/ip/bram_11b_x_2048/bram_11b_x_2048.xci \
          $CL_DIR/ip/ip/bram_32b_x_2048/bram_32b_x_2048.xci \
          $CL_DIR/ip/ip/job_log_bram/job_log_bram.xci \
          $CL_DIR/ip/ip/result_fifo/result_fifo.xci \
          $CL_DIR/ip/ip/worker_bram/worker_bram.xci
]
